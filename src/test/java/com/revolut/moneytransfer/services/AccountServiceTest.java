...
public class AccountServiceTest extends GenericServiceTest {
    ...
    public void testGetAccountByUserName() throws IOException, URISyntaxException {
        ...
        assertTrue(account.getUserName().equals("daksh"));
    }
    ...
    */
    ...
    public void testGetAccountBalance() throws  Exception {
        ...
        String value = jsonObj.getString("currentBalance");
        BigDecimal res = new BigDecimal(value).setScale(4, RoundingMode.HALF_EVEN);
    ...
    */
    ...
    public void testCreateExistingAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/account/create").build();
        Account acc = new Account("gaurav", new BigDecimal(0), "USD");
        String jsonInString = mapper.writeValueAsString(acc);
        StringEntity entity = new StringEntity(jsonInString);
        HttpPut request = new HttpPut(uri);
        request.setHeader("Content-type", "application/json");
