...
public class UserServiceTest extends GenericServiceTest {
    ...
    */
    ...
    public void testGetUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/user/saanvi").build();
        ...
        assertTrue(user.getUserName().equals("saanvi"));
        assertTrue(user.getEmailAddress().equals("saanvi@gmail.com"));
    ...
    public void testCreateUser() throws IOException, URISyntaxException {
        ...
        User user = new User("test2", "test2@gmail.com");
        ...
        assertTrue(uAfterCreation.getUserName().equals("test2"));
        assertTrue(uAfterCreation.getEmailAddress().equals("test2@gmail.com"));
    }
